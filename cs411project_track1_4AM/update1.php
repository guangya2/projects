...
<?php
	if (isset($_GET['edit1'])) {
		$eventid = $_GET['edit1'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM terrorattack WHERE eventid=$eventid");
	   if (count($record) == 1 ) {
...
<body>
  <body>
	<form method="post" action="server.php" >
		...
		<div class="input-group">
			<label>success</label>
			<input type="text" name="success" value="<?php echo $success; ?>">
		</div>
		<div class="input-group">
			<label>attacktype</label>
			<input type="text" name="attacktype" value="<?php echo  $attacktype; ?>">
		</div>
		<div class="input-group">
			<label>gname</label>
		...
		<div class="input-group">
			<label>nkill</label>
			<input type="text" name="nkill" value="<?php echo $nkill; ?>">
		</div>
    <div class="input-group">
      <label>propvalue</label>
      <input type="text" name="propvalue" value="<?php echo $propvalue; ?>">
    </div>
		<div class="input-group">
