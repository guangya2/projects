...
try {
    ...
    $sql = 'SELECT * FROM places Order By year DESC Limit 50000';
    $q = $pdo->query($sql);
...
<div class = "jumbotron">
   ...
   <p>Please find victim places data here, as well as editing or deleting a certain record.</p>
...
<?php while ($row = $q->fetch()): ?>
        <tr>
          ...
          <td><?php echo htmlspecialchars($row['longtitude']); ?></td>

          <td>
				<a href="update.php?edit=<?php echo $row['eventid']; ?>" class="edit_btn" >Edit</a>
			</td>
			<td>
				<a href="server.php?del=<?php echo $row['eventid']; ?>" class="del_btn">Delete</a>
			</td>
