            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                  ...
                  <li class="dropdown">
                      ...
                      <div class="dropdown-content">
                          <a href="#Display" onclick="location.href='./display.html';">Display</a>
                          <a href="#Insert" onclick="location.href='./register.html';">Insert</a>
                          <a href="#Delete" onclick="location.href='./delete.html';">Delete</a>
                          <a href="#Update" onclick="location.href='./update.html';">Update</a>
                          <a href="#Search" onclick="location.href='./search.html';">Search</a>
                      </div>
                    </li>
            </ul>
          </div><!--/.nav-collapse -->
...
/**
     * deleting records;we do not want to know latitude that is lower than 40
     */
<?php
...
$sql = "DELETE FROM places WHERE latitude < 40";
